...
<body>
    <section>
        ...
        if (mysqli_num_rows($result) > 0) {
            ...
            echo '<p>I am able to retrive first five cities</p>';
        }
        ?>
    </section>
    ...
    <section>
        ...
        <?php
        $ab_cities_sql = "SELECT `city_name`, `province` FROM `cities` WHERE province = 'ab'";
        ...
        if (mysqli_num_rows($ab_cities_result) > 0) {
            ...
            echo '<p>I am able to retrive cities in Alberta</p>';
        }
        ?>
    </section>
</body>
